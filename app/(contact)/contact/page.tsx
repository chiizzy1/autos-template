          ...
          <div className="flex gap-6 flex-col items-center justify-center sm:flex-row">
            <div className="flex w-full flex-col">
              <Paragraph className="max-w-lg">
                ...
                you may have. Our dedicated team is ready to assist you with any
                questions or concerns you might have regarding our services,
                appointments, or general automotive needs. Feel free to reach
                out to us using the contact information provided below.
                We&apos;re available during business hours to provide prompt and
                helpful responses. You can also use the chat widget on our
                website to send us a message directly and get instant response.
              </Paragraph>
            ...
            <div className="">
              <svg width="547" height="419" viewBox="0 0 547 419" fill="none">
                <path
